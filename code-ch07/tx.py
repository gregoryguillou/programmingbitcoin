    ...
    def sig_hash(self, input_index):
        ...
        for i, tx_in in enumerate(self.tx_ins):
            ...
            # the previous tx's ScriptPubkey is the ScriptSig
                s += TxIn(tx_in.prev_tx, tx_in.prev_index, tx_in.script_pubkey(self.testnet), tx_in.sequence).serialize()
            # Otherwise, the ScriptSig is empty
            else:
                s += TxIn(tx_in.prev_tx, tx_in.prev_index, None, tx_in.sequence).serialize()
